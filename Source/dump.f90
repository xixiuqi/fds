...
DEVICE_LOOP: DO N=1,N_DEVC
   ...
   OUTPUT_INDEX_SELECT: SELECT CASE(DV%QUANTITY_INDEX(1))
      ...
      CASE(400:460) OUTPUT_INDEX_SELECT  ! Particle-specific output
...
SELECT CASE(IND)
   ...
   CASE(460)  ! PARTICLE MASS FLUX
      PARTICLE_OUTPUT = LP%MASS_FLUX
   CASE(461)  ! PARTICLE OPPOSED VELOCITY
      PARTICLE_OUTPUT = LP%DELTA_OPPOSED
