...
OUTPUT_QUANTITY(460)%NAME = 'PARTICLE MASS FLUX'
OUTPUT_QUANTITY(460)%UNITS = 'kg/s/m2'
OUTPUT_QUANTITY(460)%SHORT_NAME = 'mass_flux'

OUTPUT_QUANTITY(461)%NAME = 'PARTICLE OPPOSED VELOCITY'
OUTPUT_QUANTITY(461)%UNITS = 'm/s'
OUTPUT_QUANTITY(461)%SHORT_NAME = 'vp'

OUTPUT_QUANTITY(434:461)%PART_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(434:461)%SLCF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(434:461)%DEVC_APPROPRIATE = .TRUE.
